...
var validate_publisher = Middleware.validate_publisher
...
module.exports = function(config, auth, storage) {
  ...
  app.put('/:package/:_rev?/:revision?', can('publish'), media('application/json'), expect_json, validate_publisher(storage), function(req, res, next) {
